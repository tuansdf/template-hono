...
export const ENV_TOKEN_RESET_PASSWORD_LIFETIME = requireNumber.parse(ENV_OBJ.APP_TOKEN_RESET_PASSWORD_LIFETIME);
export const ENV_TOKEN_ACTIVATE_ACCOUNT_LIFETIME = requireNumber.parse(ENV_OBJ.APP_TOKEN_ACTIVATE_ACCOUNT_LIFETIME);

export const ENV_EMAIL_ACTIVATE_ACCOUNT_BASE_URL = requireString.parse(ENV_OBJ.APP_EMAIL_ACTIVATE_ACCOUNT_BASE_URL);
export const ENV_EMAIL_RESET_PASSWORD_BASE_URL = requireString.parse(ENV_OBJ.APP_EMAIL_RESET_PASSWORD_BASE_URL);
